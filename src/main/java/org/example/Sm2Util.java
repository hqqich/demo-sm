...
public class Sm2Util {
	 ...
	 */
	public static byte[] encrypt(Sm2PublicKey pubKey, byte[] srcData) throws InvalidCipherTextException {
	 ...
	 * @throws IOException
	 */
	public static byte[] encryptPublic(String pubKey, byte[] srcData) throws InvalidCipherTextException, IOException {
	 ...
	 * @throws InvalidCipherTextException
	 */
	public static byte[] decrypt(Sm2PrivateKey priKey, byte[] sm2CipherText) throws InvalidCipherTextException {
		SM2Engine engine = new SM2Engine();
	 ...
	 * @throws Exception
	 */
	public static byte[] decryptPrivate(String priKey, byte[] sm2CipherText) throws Exception {
		SM2Engine engine = new SM2Engine();

		byte[] privateKeyByte = Util4Hex.hexStringToBytes(priKey);
		ECPrivateKeyParameters ECPPrivateKey = BCECUtil.convertPkcs1DerToEcPriKey(privateKeyByte);
		engine.init(false, ECPPrivateKey);
		return engine.processBlock(sm2CipherText, 0, sm2CipherText.length);
	}

	/**
	 * ECC私钥签名 不指定withId，则默认withId为字节数组:"1234567812345678".getBytes()
	 *
	 * @param priKey  ECC私钥
	 * @param srcData 源数据
	 * @return 签名
	 ...
	 */
	public static byte[] sign(Sm2PrivateKey priKey, byte[] srcData) throws Exception {
