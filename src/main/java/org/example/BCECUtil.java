...
public class BCECUtil {
	...
	public static ECPublicKeyParameters createEcPublicKey(BigInteger x, BigInteger y, ECCurve curve,
	...
	public static ECPublicKeyParameters createEcPublicKey(String xHex, String yHex, ECCurve curve,
                                                          ECDomainParameters domainParameters) {
	...
	public static ECPublicKeyParameters createEcPublicKey(byte[] xBytes, byte[] yBytes, ECCurve curve,
                                                          ECDomainParameters domainParameters) {
